 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (vershoks * 0.04445 + arshins * 16 *
        0.04445 +  sagenes * 48 * 0.04445)
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double =  (grad * 60 * 60 + min * 60 + sec) / (180  / PI * 60 * 60)
...
fun accountInThreeYears(initial: Int, percent: Int): Double =
        (initial *  sqr(1 + percent / 100.0)) * (1 + percent / 100.0)
